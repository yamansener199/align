...
namespace align.Migrations
{
    ...
    [Migration("20240312154004_product_user_many_to_many2")]
    partial class product_user_many_to_many2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("align.Data.Entities.ProductAssignHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductAssignHistory", (string)null);
                });

            modelBuilder.Entity("align.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("align.Data.Entities.ProductAssignHistory", b =>
                {
                    b.HasOne("align.Data.Entities.User", "AssignerUser")
                        .WithMany("ProductAssignHistoriesAsAssigner")
                        .HasForeignKey("AssignerUserId")
                        .IsRequired()
                        .HasConstraintName("FK_ProductAssignHistory_AssignerUser");

                    b.HasOne("align.Data.Entities.Product", "Product")
                        .WithMany("ProductAssignHistories")
                        .HasForeignKey("ProductId")
                        .IsRequired()
                        .HasConstraintName("FK_ProductAssignHistory_Product");

                    b.HasOne("align.Data.Entities.User", "RegionManager")
                        .WithMany("ProductAssignHistoriesAsRegionManager")
                        .HasForeignKey("RegionManagerId")
                        .IsRequired()
            ...
            modelBuilder.Entity("align.Data.Entities.Product", b =>
                {
                    ...
                    b.Navigation("ProductAssignHistories");
                });
